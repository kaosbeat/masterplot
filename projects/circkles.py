...
size = 3501
circlesize = 800
brokencircle(1.1*size-150,size+300, 20 ,0.92, 50, size)
brokencircle(1.1*size-130,size+320, 10 ,0.99, 30, 0.8*size)

#brokenrotatedcircle(size/2,size/2, 40 , 0.92, 8, size)

x= 40
y=0
#brokenrotatedcircle(size/2+circlesize,size/2+circlesize, 49 + 20*y , 0.978, 10 + x + 2*y, size)
