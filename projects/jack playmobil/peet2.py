...
def plotcover(start,end):
        ...
        plotter.select_pen(2)
        writeword("M", 40, "3dlet.ttf", 500+l1offset[0] ,topl+l1offset[1])
        writeword("ouche", 9, "powerpuff.ttf", 1400+w1offset[0],topw+w1offset[1])
        writeword("D", 40, "3dlet.ttf", 5000+l2offset[0],topl+l2offset[1])
        writeword("rouhin", 10, "powerpuff.ttf", 5900+w2offset[0],topw+w2offset[1])
        # writeword("aa", 16, "neon.ttf", 3500,8300)
        writeword("B", 40, "3dlet.ttf", 500+l1offset[0],topl-ruleheight+l1offset[1])
        writeword("arocci", 9, "powerpuff.ttf", 1400+w1offset[0],topw-ruleheight+w1offset[1])
        writeword("M", 40, "3dlet.ttf", 5750+l2offset[0],topl-ruleheight+l2offset[1])
        writeword("ejami", 9, "powerpuff.ttf", 6650+w2offset[0],topw-ruleheight+w2offset[1])
        # writeword("eew", 16, "sqd.ttf", 3500,6300)
        writeword("C", 40, "3dlet.ttf", 500+l1offset[0],topl-2*ruleheight+l1offset[1])
        writeword("entre", 9, "powerpuff.ttf", 1400+w1offset[0],topw-2*ruleheight+w1offset[1])
        writeword("D", 40, "3dlet.ttf", 4750+l2offset[0],topl-2*ruleheight+l2offset[1])
        writeword("ata", 9, "powerpuff.ttf", 5650+w2offset[0],topw-2*ruleheight+w2offset[1])
        writeword("X", 40, "3dlet.ttf", 9000,topl-2*ruleheight+l2offset[1])
        writeword("D", 40, "3dlet.ttf", 500+l1offset[0],topl-3*ruleheight+l1offset[1])
        writeword("ry", 9, "powerpuff.ttf", 1400+w1offset[0],topw-3*ruleheight+w1offset[1])
        writeword("D", 40, "3dlet.ttf", 2850+l2offset[0],topl-3*ruleheight+l2offset[1])
        writeword("ocks", 9, "powerpuff.ttf", 3750+w2offset[0],topw-3*ruleheight+w2offset[1])
        writeword("B", 40, "3dlet.ttf", 500+l1offset[0],topl-4*ruleheight+l1offset[1])
        writeword("arocci", 9, "powerpuff.ttf", 1400+w1offset[0],topw-4*ruleheight+w1offset[1])
        writeword("M", 40, "3dlet.ttf", 5750+l2offset[0],topl-4*ruleheight+l2offset[1])
        writeword("ejami", 9, "powerpuff.ttf", 6650+w2offset[0],topw-4*ruleheight+w2offset[1])
        writeword("R", 40, "3dlet.ttf", 3750+l2offset[0],topl-5*ruleheight+l2offset[1] +800 )
        writeword("eprise", 9, "powerpuff.ttf", 4650+w2offset[0],topw-5*ruleheight+w2offset[1] + 400 ) 
